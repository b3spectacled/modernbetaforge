...
public class BiomeDecoratorInfdev420 extends ModernBetaBiomeDecorator {
    @Override
    ...
    protected int getTreeCount(World world, Random random, Biome biome, BlockPos startPos) {
        ...
        double scale = 0.05;
        int treeCount = (int) (forestOctaveNoise.sampleXY(startX * scale, startZ * scale) - random.nextDouble());
