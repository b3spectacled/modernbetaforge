...
public class GuiTags {
    ...
    public static final int PG3_S_TEMP_SCL = 413;
    public static final int PG3_S_RAIN_SCL = 414;
    public static final int PG3_S_DETL_SCL = 415;
    
    public static final int PG3_S_B_DPTH_WT = 416;
    ...
    public static final int PG4_F_TEMP_SCL = 513;
    public static final int PG4_F_RAIN_SCL = 514;
    public static final int PG4_F_DETL_SCL = 515;
    
    public static final int PG4_F_B_DPTH_WT = 516;
