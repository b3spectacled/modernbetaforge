   ...
   private GuiButton presets;
    ...
    private void createPagedList() {
        ...
        GuiPageButtonList.GuiListEntry[] pageOre = {
            ...
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_CLAY_SIZE, "size", 1.0f, 50.0f, (float)this.settings.claySize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_CLAY_CNT, "count", 0.0f, 40.0f, (float)this.settings.clayCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_CLAY_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.clayMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_CLAY_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.clayMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_DIRT_NAME, I18n.format("tile.dirt.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_DIRT_SIZE, "size", 1.0f, 50.0f, (float)this.settings.dirtSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIRT_CNT, "count", 0.0f, 40.0f, (float)this.settings.dirtCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIRT_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.dirtMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIRT_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.dirtMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_GRAV_NAME, I18n.format("tile.gravel.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_GRAV_SIZE, "size", 1.0f, 50.0f, (float)this.settings.gravelSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GRAV_CNT, "count", 0.0f, 40.0f, (float)this.settings.gravelCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GRAV_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.gravelMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GRAV_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.gravelMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_GRAN_NAME, I18n.format("tile.stone.granite.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_GRAN_SIZE, "size", 1.0f, 50.0f, (float)this.settings.graniteSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GRAN_CNT, "count", 0.0f, 40.0f, (float)this.settings.graniteCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GRAN_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.graniteMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GRAN_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.graniteMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_DIOR_NAME, I18n.format("tile.stone.diorite.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_DIOR_SIZE, "size", 1.0f, 50.0f, (float)this.settings.dioriteSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIOR_CNT, "count", 0.0f, 40.0f, (float)this.settings.dioriteCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIOR_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.dioriteMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIOR_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.dioriteMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_ANDE_NAME, I18n.format("tile.stone.andesite.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_ANDE_SIZE, "size", 1.0f, 50.0f, (float)this.settings.andesiteSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_ANDE_CNT, "count", 0.0f, 40.0f, (float)this.settings.andesiteCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_ANDE_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.andesiteMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_ANDE_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.andesiteMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_COAL_NAME, I18n.format("tile.oreCoal.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_COAL_SIZE, "size", 1.0f, 50.0f, (float)this.settings.coalSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_COAL_CNT, "count", 0.0f, 40.0f, (float)this.settings.coalCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_COAL_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.coalMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_COAL_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.coalMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_IRON_NAME, I18n.format("tile.oreIron.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_IRON_SIZE, "size", 1.0f, 50.0f, (float)this.settings.ironSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_IRON_CNT, "count", 0.0f, 40.0f, (float)this.settings.ironCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_IRON_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.ironMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_IRON_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.ironMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_GOLD_NAME, I18n.format("tile.oreGold.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_GOLD_SIZE, "size", 1.0f, 50.0f, (float)this.settings.goldSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GOLD_CNT, "count", 0.0f, 40.0f, (float)this.settings.goldCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GOLD_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.goldMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_GOLD_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.goldMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_REDS_NAME, I18n.format("tile.oreRedstone.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_REDS_SIZE, "size", 1.0f, 50.0f, (float)this.settings.redstoneSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_REDS_CNT, "count", 0.0f, 40.0f, (float)this.settings.redstoneCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_REDS_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.redstoneMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_REDS_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.redstoneMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_DIAM_NAME, I18n.format("tile.oreDiamond.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_DIAM_SIZE, "size", 1.0f, 50.0f, (float)this.settings.diamondSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIAM_CNT, "count", 0.0f, 40.0f, (float)this.settings.diamondCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIAM_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.diamondMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_DIAM_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.diamondMaxHeight, this),
            
            createGuiLabelNoPrefix(GuiIdentifiers.PG3_L_LAPS_NAME, I18n.format("tile.oreLapis.name")),
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_LAPS_SIZE, "size", 1.0f, 50.0f, (float)this.settings.lapisSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_LAPS_CNT, "count", 0.0f, 40.0f, (float)this.settings.lapisCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_LAPS_CTR, "center", 0.0f, MAX_HEIGHT, (float)this.settings.lapisCenterHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_LAPS_SPR, "spread", 1.0f, MAX_HEIGHT, (float)this.settings.lapisSpread, this),
            ...
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_EMER_SIZE, "size", 1.0f, 50.0f, (float)this.settings.emeraldSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_EMER_CNT, "count", 0.0f, 40.0f, (float)this.settings.emeraldCount, this),
            createGuiSlider(GuiIdentifiers.PG3_S_EMER_MIN, "minHeight", 0.0f, MAX_HEIGHT, (float)this.settings.emeraldMinHeight, this),
            createGuiSlider(GuiIdentifiers.PG3_S_EMER_MAX, "maxHeight", 0.0f, MAX_HEIGHT, (float)this.settings.emeraldMaxHeight, this),
            ...
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_QRTZ_SIZE, "size", 1.0f, 50.0f, (float)this.settings.quartzSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_QRTZ_CNT, "count", 0.0f, 40.0f, (float)this.settings.quartzCount, this),
            ...
            null,
            createGuiSlider(GuiIdentifiers.PG3_S_MGMA_SIZE, "size", 1.0f, 50.0f, (float)this.settings.magmaSize, this),
            createGuiSlider(GuiIdentifiers.PG3_S_MGMA_CNT, "count", 0.0f, 40.0f, (float)this.settings.magmaCount, this),
        };
        
        GuiPageButtonList.GuiListEntry[] pageNoise0 = {
            createGuiSlider(GuiIdentifiers.PG4_S_MAIN_NS_X, NbtTags.MAIN_NOISE_SCALE_X, 1.0f, 5000.0f, this.settings.mainNoiseScaleX, this),
            createGuiSlider(GuiIdentifiers.PG4_S_MAIN_NS_Y, NbtTags.MAIN_NOISE_SCALE_Y, 1.0f, 5000.0f, this.settings.mainNoiseScaleY, this),
            createGuiSlider(GuiIdentifiers.PG4_S_MAIN_NS_Z, NbtTags.MAIN_NOISE_SCALE_Z, 1.0f, 5000.0f, this.settings.mainNoiseScaleZ, this),
            createGuiSlider(GuiIdentifiers.PG4_S_SCLE_NS_X, NbtTags.SCALE_NOISE_SCALE_X, 1.0f, 20.0f, this.settings.scaleNoiseScaleX, this),
            createGuiSlider(GuiIdentifiers.PG4_S_SCLE_NS_Z, NbtTags.SCALE_NOISE_SCALE_Z, 1.0f, 20.0f, this.settings.scaleNoiseScaleZ, this),
            createGuiSlider(GuiIdentifiers.PG4_S_DPTH_NS_X, NbtTags.DEPTH_NOISE_SCALE_X, 1.0f, 2000.0f, this.settings.depthNoiseScaleX, this),
            createGuiSlider(GuiIdentifiers.PG4_S_DPTH_NS_Z, NbtTags.DEPTH_NOISE_SCALE_Z, 1.0f, 2000.0f, this.settings.depthNoiseScaleZ, this),
            createGuiSlider(GuiIdentifiers.PG4_S_BASE_SIZE, NbtTags.BASE_SIZE, 1.0f, 25.0f, this.settings.baseSize, this),
            createGuiSlider(GuiIdentifiers.PG4_S_COORD_SCL, NbtTags.COORDINATE_SCALE, 1.0f, 6000.0f, this.settings.coordinateScale, this),
            createGuiSlider(GuiIdentifiers.PG4_S_HEIGH_SCL, NbtTags.HEIGHT_SCALE, 1.0f, 6000.0f, this.settings.heightScale, this),
            createGuiSlider(GuiIdentifiers.PG4_S_STRETCH_Y, NbtTags.STRETCH_Y, 0.01f, 50.0f, this.settings.stretchY, this),
            createGuiSlider(GuiIdentifiers.PG4_S_UPPER_LIM, NbtTags.UPPER_LIMIT_SCALE, 1.0f, 5000.0f, this.settings.upperLimitScale, this),
