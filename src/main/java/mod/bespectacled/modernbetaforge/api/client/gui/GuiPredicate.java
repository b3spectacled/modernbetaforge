...
public class GuiPredicate {
    ...
    public static final ResourceLocation ORE_TYPE = createRegistryKey(NbtTags.ORE_TYPE);
    ...
    public static final ResourceLocation USE_TERRAIN_COORD_FIX = createRegistryKey(NbtTags.USE_TERRAIN_COORD_FIX);
    ...
    public static final ResourceLocation RIVER_DEPTH_WEIGHT = createRegistryKey(NbtTags.RIVER_DEPTH_WEIGHT);
    ...
    public static final ResourceLocation DEEPEN_RIVERS = createRegistryKey(NbtTags.DEEPEN_RIVERS);
