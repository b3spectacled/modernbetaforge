...
public class ModernBetaBuiltInRegistries {
    ...
    public static void registerPredicates() {
        ...
        registry.register(GuiPredicate.RIVER_DEPTH_WEIGHT, GuiPredicates.RIVER_DEPTH_WEIGHT_TEST);
        ...
        registry.register(GuiPredicate.BASE_BIOME_DESERT, GuiPredicates.BASE_BIOME_DESERT_TEST);
        registry.register(GuiPredicate.BASE_BIOME_FOREST, GuiPredicates.BASE_BIOME_FOREST_TEST);
        registry.register(GuiPredicate.BASE_BIOME_ICE_DESERT, GuiPredicates.BASE_BIOME_ICE_DESERT_TEST);
        registry.register(GuiPredicate.BASE_BIOME_PLAINS, GuiPredicates.BASE_BIOME_PLAINS_TEST);
        registry.register(GuiPredicate.BASE_BIOME_RAINFOREST, GuiPredicates.BASE_BIOME_RAINFOREST_TEST);
        registry.register(GuiPredicate.BASE_BIOME_SAVANNA, GuiPredicates.BASE_BIOME_SAVANNA_TEST);
        registry.register(GuiPredicate.BASE_BIOME_SEASONAL_FOREST, GuiPredicates.BASE_BIOME_SEASONAL_FOREST_TEST);
        registry.register(GuiPredicate.BASE_BIOME_SHRUBLAND, GuiPredicates.BASE_BIOME_SHRUBLAND_TEST);
        registry.register(GuiPredicate.BASE_BIOME_SWAMPLAND, GuiPredicates.BASE_BIOME_SWAMPLAND_TEST);
        registry.register(GuiPredicate.BASE_BIOME_TAIGA, GuiPredicates.BASE_BIOME_TAIGA_TEST);
        registry.register(GuiPredicate.BASE_BIOME_TUNDRA, GuiPredicates.BASE_BIOME_TUNDRA_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_DESERT, GuiPredicates.OCEAN_BIOME_DESERT_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_FOREST, GuiPredicates.OCEAN_BIOME_FOREST_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_ICE_DESERT, GuiPredicates.OCEAN_BIOME_ICE_DESERT_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_PLAINS, GuiPredicates.OCEAN_BIOME_PLAINS_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_RAINFOREST, GuiPredicates.OCEAN_BIOME_RAINFOREST_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_SAVANNA, GuiPredicates.OCEAN_BIOME_SAVANNA_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_SEASONAL_FOREST, GuiPredicates.OCEAN_BIOME_SEASONAL_FOREST_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_SHRUBLAND, GuiPredicates.OCEAN_BIOME_SHRUBLAND_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_SWAMPLAND, GuiPredicates.OCEAN_BIOME_SWAMPLAND_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_TAIGA, GuiPredicates.OCEAN_BIOME_TAIGA_TEST);
        registry.register(GuiPredicate.OCEAN_BIOME_TUNDRA, GuiPredicates.OCEAN_BIOME_TUNDRA_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_DESERT, GuiPredicates.BEACH_BIOME_DESERT_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_FOREST, GuiPredicates.BEACH_BIOME_FOREST_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_ICE_DESERT, GuiPredicates.BEACH_BIOME_ICE_DESERT_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_PLAINS, GuiPredicates.BEACH_BIOME_PLAINS_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_RAINFOREST, GuiPredicates.BEACH_BIOME_RAINFOREST_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_SAVANNA, GuiPredicates.BEACH_BIOME_SAVANNA_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_SEASONAL_FOREST, GuiPredicates.BEACH_BIOME_SEASONAL_FOREST_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_SHRUBLAND, GuiPredicates.BEACH_BIOME_SHRUBLAND_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_SWAMPLAND, GuiPredicates.BEACH_BIOME_SWAMPLAND_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_TAIGA, GuiPredicates.BEACH_BIOME_TAIGA_TEST);
        registry.register(GuiPredicate.BEACH_BIOME_TUNDRA, GuiPredicates.BEACH_BIOME_TUNDRA_TEST);
